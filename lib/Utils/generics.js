...
/**
 * utility that fetches latest Electric Blue version from the master branch.
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/reys66223-art/Waysocket-Baileys/main/lib/Defaults/baileys-version.json';
    try {
...
/**
 * Stream errors generally provide a reason, map that to an Electric Blue DisconnectReason
